...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/RESTful_API-009688?style=for-the-badge&logo=api&logoColor=white" />
  <img src="https://img.shields.io/badge/Modular_Architecture-4EAA25?style=for-the-badge&logo=code&logoColor=white" />
</p>

- **Primary Stack:** PHP + Laravel (for robust, API‑driven backends).
...
- **OS:** Linux (administration, scripting, troubleshooting).
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/LLMs_%26_Agents-8B0000?style=for-the-badge&logo=openai&logoColor=white" />
</p>
...
- Multi‑Vendor Marketplace (physical & digital products)
- Vendor & Product Management
- Orders, Payments & Discounts
- Reviews & Content Management
- Dynamic CRUD & Reusable Components
- Security Module & Event‑based Concepts
...
Every project I build must:

- 🎯 Solve a **real‑world business problem** (no to‑do lists)
- 🧩 Have **multiple interactive modules** (not a single feature)
- 📐 Be **clearly architected**, documented, and maintainable
- 🚀 Be **deployable** and **evolvable** over time
- 📊 Deliver **measurable outcomes** (actual metrics)

**Ideal Project Types:**
- 🤖 Multi‑Vendor Commerce Platform
- 🚨 Monitoring & Alerting Systems
- 🔒 Secure Data/Request Services
- 📊 Log/Event Aggregation & Analytics
- 🔗 Service Orchestration & Business Workflows
...
- BM25 (lexical)
- ParsBERT (semantic)
- Reciprocal Rank Fusion (RRF) & Weighted Fusion
- Persian text preprocessing & vector representations

Evaluated on the **PQuAD dataset** with metrics: Precision, Recall, MRR, MAP, NDCG, F1.

### Current Research: Intelligent Business Agents

I'm exploring **LLM‑based agents** that support organizations through:
...
Goal: move beyond chat interfaces into **useful, integrated decision‑support components**.
...
In progress:
- **الفبای وب** — A book on HTML & web fundamentals
- **راگای رشد: رنسانس فروش در عصر دیجیتال** — A practical book on digital business, sales & growth
...
## ⚠️ The Anti‑Shiny‑Object Discipline

| # | Law | Rationale |
|---|-----|-----------|
| **1** | **One Main Path** – `Software Engineering + Product Development + AI/NLP` | Depth over breadth |
| **2** | **One Active Sub‑skill** – Security OR Data OR DevOps | Never all three at once |
| **3** | **The "Someday" List** – New ideas go to a queue | Prevents impulsive pivots |
| **4** | **12‑Week Reviews** – Never daily, never weekly | Emotional decisions are dangerous |

> 💡 **Filter Question:** *"Does this topic help me build a real system? Is it relevant to my core path? Does it make me think better, or just learn more?"*
